...
void FShaderModule::StartupModule()
{
	...
	FString PluginShaderDir = FPaths::Combine(IPluginManager::Get().FindPlugin(TEXT("ProceduralTerrainGeneration"))->GetBaseDir(), TEXT("Shaders/Private"));
	AddShaderSourceDirectoryMapping(TEXT("/Plugins/ProceduralTerrainGeneration"), PluginShaderDir);
}
